# -*- coding: utf-8 -*-
"""
Created on Fri Mar  1 15:22:26 2024
...
class PEC_Cell():
    ...
    def Set_scenario(self,scenario):
        ...
        elif scenario=='OD(II)-Cu_NiFeOx_high_pH_1:1':
        ...
        elif scenario=='OD(II)-Cu_NiFeOx_high_pH_sparse_coverage':
            #Scenario A
        ...
        elif scenario=='OD(II)-Cu_NiFeOx_high_pH_Solar_concentration':
            #Scenario B
        ...
        elif scenario=='OD(II)-Cu_NiFeOx_high_pH_PV_EC':
            #Scenario C
            self.PEC_mode='PV-EC'
            self.Reduction_mode='CO2 reduction'
            self.CO2RR_catalyst='OIID-Cu'
        ...
        elif scenario=='OD(II)-Cu_NiFeOx_high_pH_sparse_coverage_Three_solar_cells':
    ...
    def Data_CO2RR_catalyst(self):
        ...
        elif self.CO2R_catalyst=='Choi2020':
            #Choi, C., Kwon, S., Cheng, T. et al. Highly active and stable stepped Cu surface for enhanced electrochemical CO2 reduction to C2H4. Nat Catal 3, 804–812 (2020). https://doi.org/10.1038/s41929-020-00504-x
    ...
    def Calculate_converter_PV_EC(self,eta_membrane=0.1,converter_efficiency=1):
        ...
        self.Plot_matrix(Solar_cell_1_range,Solar_cell_2_range,self.umol_cm2[:,:,0],xmax=self.Max_efficiency_Solar_cell_2_index,ymax=self.Max_efficiency_Solar_cell_1_index,boxtext='',unit=' $\mu$mol/h/cm$^2$ C$_2$H$_4$', title='',cmap='Purples_r',levels=[0,4,8,12,16,20,24,28,32,36],clabel='C$_2$H$_4$ production rate ($\mu$mol/h/cm$^2$)')
    ...
    def Plot_1_1_matrix(self):
        ...
        if self.Reduction_mode=='HER': 
          self.Plot_matrix(Solar_cell_1_range,Solar_cell_2_range,self.one_one_Efficiency_matrix,xmax=Max_efficiency_Solar_cell_2,ymax=Max_efficiency_Solar_cell_1,boxtext='no',unit='%',levels=[0.5,3.5,6.5,9.5,12.5,15.5,18.5,21.5,24.5,27.5,30.5],cmap='Greens_r',clabel='STE efficiency (%)')
            ...
            self.Plot_matrix(Solar_cell_1_range,Solar_cell_2_range,self.one_one_umol_C2H4_matrix,xmax=Max_efficiency_Solar_cell_2,ymax=Max_efficiency_Solar_cell_1,boxtext='',unit=' $\mu$mol/h/cm$^2$ C$_2$H$_4$', title='',cmap='Purples_r',levels=[0,4,8,12,16,20,24,28,32,36],clabel='C$_2$H$_4$ production rate ($\mu$mol/h/cm$^2$)')
    ...
    def Plot_sparse_coverage_matrix(self):
        ...
        self.Plot_matrix(Solar_cell_1_range,Solar_cell_2_range,self.Sparse_Coverage_umol_C2H4_matrix,xmax=Max_efficiency_Solar_cell_2,ymax=Max_efficiency_Solar_cell_1,boxtext='',unit=' $\mu$mol/h/cm$^2$ C$_2$H$_4$', title='',cmap='Purples_r',levels=[0,4,8,12,16,20,24,28,32,36],clabel='C$_2$H$_4$ production rate ($\mu$mol/h/cm$^2$)')
    ...
    def Plot_solar_concentration_matrix(self):
        ...
        self.Plot_matrix(Solar_cell_1_range,Solar_cell_2_range,self.solar_light_concentration_umol_C2H4_matrix,xmax=Max_efficiency_Solar_cell_2,ymax=Max_efficiency_Solar_cell_1,boxtext='',unit=' $\mu$mol/h/cm$^2$ C$_2$H$_4$', title='',cmap='Purples_r',levels=[0,4,8,12,16,20,24,28,32,36],clabel='C$_2$H$_4$ production rate ($\mu$mol/h/cm$^2$)')
    ...
    def Plot_PV_EC_matrix(self):
        ...
        self.Plot_matrix(Solar_cell_1_range,Solar_cell_2_range,self.PV_EC_umol_C2H4_matrix,xmax=Max_efficiency_Solar_cell_2,ymax=Max_efficiency_Solar_cell_1,boxtext='',unit=' $\mu$mol/h/cm$^2$ C$_2$H$_4$', title='',cmap='Purples_r',levels=[0,4,8,12,16,20,24,28,32,36],clabel='C$_2$H$_4$ production rate ($\mu$mol/h/cm$^2$)')
        self.Plot_matrix(Solar_cell_1_range,Solar_cell_2_range,self.PV_EC_scaling_matrix,xmax=Max_efficiency_Solar_cell_2,ymax=Max_efficiency_Solar_cell_1,boxtext='PV-EC scaling by factor: ',unit='x', title='',cmap='Blues_r',levels=[0,5,10,15,20,25,30,35],clabel='PV-EC scaling')
    ...
    def Vary_Solar_Intensity(self,Bandgap_1,Bandgap_2,Solar_Concentration_range=np.arange(0.1,1.5,0.01),plot_graph_solar=True):
        ...
        if plot_graph_solar:
            ...
            self.plot_graph_vary_intensity(Solar_Concentration_range *Standard_Solarpower, Efficiencies, 'Solarconcentration (mW/cm$^2$)','STE (%)')
            self.plot_graph_vary_intensity(Solar_Concentration_range *Standard_Solarpower, FEs, 'Solarconcentration (mW/cm$^2$)','Overall Faradaic efficiency (%)')
            self.plot_graph_vary_intensity(Solar_Concentration_range *Standard_Solarpower, Voltages, 'Solarconcentration (mW/cm$^2$)','Overall Voltage (V)')
            self.plot_graph_vary_intensity(Solar_Concentration_range *Standard_Solarpower, Currents, 'Solarconcentration (mW/cm$^2$)','Used photocurrent (mA/cm$^2$)',linear=1)
            self.plot_graph_vary_intensity(Solar_Concentration_range *Standard_Solarpower,  umol_C2H4, 'Solarconcentration (mW/cm$^2$)','Produces C$_2$H$_4$ ($\mu$mol / h / cm$^2$)',linear=1)
...
#Scenario A       
A=PEC_Cell()
A.Calculate_setup(scenario='OD(II)-Cu_NiFeOx_high_pH_sparse_coverage')
print(A.Co2RcatalystConcentrator)
A.Vary_Solar_Intensity(A.Solar_cell_combination[0],A.Solar_cell_combination[1])
print(A.Co2RcatalystConcentrator)

#Scenario B
B=PEC_Cell()
B.Calculate_setup(scenario='OD(II)-Cu_NiFeOx_high_pH_Solar_concentration')

# #Scenario C
C=PEC_Cell()
C.Calculate_setup(scenario='Solar cells & Electrolyzers OD(II)-Cu_NiFeOx_high_pH')

#Fail Scenario

F=PEC_Cell()
F.Calculate_setup(scenario='OD(II)-Cu_NiFeOx_high_pH_1:1')

# #Linear rate CuAg catalyst
CuAg=PEC_Cell()
CuAg.Calculate_setup(scenario='CuAg-NiFeOx_high_pH')
print(CuAg.Co2RcatalystConcentrator)
...
#OD(I)-Cu
ODICu=PEC_Cell()
ODICu.Calculate_setup(scenario='OD(I)-Cu_NiFeOx_high_pH_sparse_coverage')
print(ODICu.Co2RcatalystConcentrator)
ODICu.Vary_Solar_Intensity(ODICu.Solar_cell_combination[0],ODICu.Solar_cell_combination[1])
print(ODICu.Co2RcatalystConcentrator)
...
T.Calculate_setup(scenario='OD(II)-Cu_NiFeOx_high_pH_sparse_coverage_Three_solar_cells')
