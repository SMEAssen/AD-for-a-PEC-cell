...
This script calculates the sparse coverage approach for PEC cells that reduce CO2 into C2H4 optimal at AM1.5G using a triple solar cell. This generates Figure S12.  
